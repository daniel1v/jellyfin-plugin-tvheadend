...
public sealed class IdrScanTests : IDisposable
{
    ...
    public void SomethingThatIsNotATransportStreamRaisesNoObjection()
    {
        ...
        Assert.NotEqual(H264RandomAccessKind.RecoveryOpenGop, RecordingDescriber.ScanRandomAccess(_path));
    }
    ...
    {
        Assert.ThrowsAny<ArgumentException>(() => RecordingDescriber.ScanRandomAccess(string.Empty));
    }
}
