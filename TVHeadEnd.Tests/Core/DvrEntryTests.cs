...
public class DvrEntryTests
{
    ...
    public void AStateTheServerDoesNotSendIsNotInvented()
    {
        ...
        var entry = DvrEntryMapper.FromMessage(Message(id: 1, state: "something-new"));
    ...
    {
        var entry = DvrEntryMapper.FromMessage(Message(id: 1, state: state))!;
    ...
    public void ARecordingInProgressIsBothAtOnce()
    {
        ...
        var entry = DvrEntryMapper.FromMessage(Message(id: 1, state: "recording"))!;
    ...
    {
        var entry = DvrEntryMapper.FromMessage(Message(id: 3, state: "scheduled", title: "Tatort"))!;
    ...
    public void ARecordingKeepsNoPathBecauseTheFileIsOnTheOtherServer()
    {
        ...
        var recording = JellyfinDvrMapper.ToRecording(DvrEntryMapper.FromMessage(message)!);
    ...
    {
        Assert.Null(DvrEntryMapper.FromMessage(new HtspMessage()));
    }
    ...
    public void ARecordingCarriesAModificationDateSoJellyfinCanRefreshIt()
    {
        ...
        var entry = DvrEntryMapper.FromMessage(Message(id: 3, state: "completed", title: "Tatort"))!;
        ...
        var withAFile = DvrEntryMapper.FromMessage(WithFile(Message(id: 3, state: "completed"), entry.StartUtc.AddMinutes(20)))!;
    ...
    {
        var entry = DvrEntryMapper.FromMessage(Message(id: 4711, state: "completed", title: "Tatort"));
