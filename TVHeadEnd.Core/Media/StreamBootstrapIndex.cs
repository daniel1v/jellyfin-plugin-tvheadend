...
/// </para>
/// <para>
/// Positions are the logical, ever-increasing write positions of the buffer the stream is being
/// written into, not offsets into a file, so points that have been overwritten fall out by
/// comparing against the oldest position still held.
/// </para>
/// </remarks>
